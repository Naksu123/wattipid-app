...
const ICONS = {
  ...
  'tips': { active: 'bulb', inactive: 'bulb-outline' },
  'budget': { active: 'wallet', inactive: 'wallet-outline' },
  'billing/index': { active: 'receipt', inactive: 'receipt-outline' },
};
...
const TabBarItem = ({ isFocused, onPress, onLongPress, routeName }) => {
  ...
  return (
    ...
    >
      ...
      {/* Active screen indicator: Sleek horizontal pill matching tenant-dashboard.png */}
      <Animated.View 
        style={[
...
const styles = StyleSheet.create({
  ...
  blurContainer: {
    ...
    width: '100%',
    height: 64,
    backgroundColor: '#0C1322', // Sleek dark navy matching tenant-dashboard.png
    borderRadius: 32,
    borderWidth: 1,
