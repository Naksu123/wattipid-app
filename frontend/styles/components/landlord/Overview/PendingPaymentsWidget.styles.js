...
export default StyleSheet.create({
  ...
  sectionTitle: { fontSize: 15, fontWeight: FONT_WEIGHT.semibold, color: '#94a3b8', letterSpacing: 0.5, marginBottom: 12, marginLeft: 4, marginTop: 16 },
  ...
  tenantName: { fontSize: 15, fontWeight: FONT_WEIGHT.bold, color: '#f8fafc', marginBottom: 4 },
  referenceText: { fontSize: 13, color: '#94a3b8' },
  amount: { fontSize: 20, fontWeight: FONT_WEIGHT.bold, color: '#f59e0b' },
