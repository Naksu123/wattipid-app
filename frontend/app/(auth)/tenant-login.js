...
export default function TenantLoginScreen() {
  ...
  const validate = () => {
    const e = {};
    if (!email.trim()) e.email = 'Tenant email is required';
      ...
      >
        ...
        >
          ...
          <View style={styles.headerBlock}>
            <View style={styles.tenantIconAura}>
              <Ionicons name="flash-outline" size={28} color="#10B981" />
            </View>
            <Text style={styles.title}>Welcome Back, Tenant</Text>
            <Text style={styles.subtitle}>
              Sign in to monitor real-time submeter power, track your budget, and manage bill payments.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>TENANT EMAIL ADDRESS</Text>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
              onPress={() => router.push({ pathname: '/(auth)/forgot-password', params: { role: 'tenant' } })}
            >
            ...
            >
              {isLoading ? (
                ...
                <Text style={styles.primaryBtnText}>Sign In as Tenant</Text>
              )}
            </TouchableOpacity>
          </View>

          {/* Submeter Registration Guide Box */}
          <View style={styles.infoBanner}>
            <Ionicons name="information-circle-outline" size={18} color="#10B981" />
            <Text style={styles.infoBannerText}>
              Submeter access requires an invitation code from your landlord to activate billing.
            </Text>
          </View>
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.8}
            onPress={() => router.push('/(auth)/tenant-register')}
          >
            <Text style={styles.registerText}>
              Don&apos;t have an account? <Text style={styles.registerLink}>Create Tenant Account</Text>
            </Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
