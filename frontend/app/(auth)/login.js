...
import { COLORS, FONT_SIZE, FONT_WEIGHT, RADIUS, SPACING, SHADOWS, GRADIENTS } from '@/styles/theme';
...
const s = StyleSheet.create({
  ...
  forgotText: { fontSize: FONT_SIZE.sm, color: COLORS.primary, fontWeight: FONT_WEIGHT.medium },
