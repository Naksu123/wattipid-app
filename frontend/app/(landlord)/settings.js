...
import { COLORS, FONT_SIZE, FONT_WEIGHT, RADIUS, SPACING, GRADIENTS, SHADOWS } from '@/styles/theme';
...
const s = StyleSheet.create({
  ...
  // Profile
  profileCard: { alignItems: 'center', marginBottom: SPACING.lg, paddingVertical: SPACING.xl },
  ...
  rateTitle: { fontSize: FONT_SIZE.lg, fontWeight: FONT_WEIGHT.semibold, color: COLORS.textPrimary },
  rateDesc: { fontSize: FONT_SIZE.sm, color: COLORS.textSecondary, lineHeight: 20, marginBottom: SPACING.md },
  rateRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm },
  currencyLabel: { fontSize: FONT_SIZE.xl, fontWeight: FONT_WEIGHT.bold, color: COLORS.primary },
  input: { flex: 1, height: 48, backgroundColor: COLORS.backgroundLight, borderRadius: RADIUS.md, paddingHorizontal: SPACING.md, fontSize: FONT_SIZE.md, color: COLORS.textPrimary, borderWidth: 1, borderColor: COLORS.border },
  rateBtn: { paddingHorizontal: SPACING.lg, paddingVertical: SPACING.md, borderRadius: RADIUS.md },
  rateBtnText: { fontSize: FONT_SIZE.md, fontWeight: FONT_WEIGHT.semibold, color: '#fff' },
  ...
  modal: { backgroundColor: COLORS.surface, borderRadius: RADIUS.xl, padding: SPACING.xl, width: '100%', maxWidth: 380, borderWidth: 1, borderColor: COLORS.border, ...SHADOWS.lg },
  modalIconWrap: { width: 68, height: 68, borderRadius: 20, alignItems: 'center', justifyContent: 'center', alignSelf: 'center', marginBottom: SPACING.md },
  modalTitle: { fontSize: FONT_SIZE.xl, fontWeight: FONT_WEIGHT.bold, color: COLORS.textPrimary, textAlign: 'center', marginBottom: SPACING.xs },
  modalVer: { fontSize: FONT_SIZE.sm, color: COLORS.textMuted, textAlign: 'center', marginBottom: SPACING.sm },
  modalDesc: { fontSize: FONT_SIZE.sm, color: COLORS.textSecondary, textAlign: 'center', lineHeight: 20, marginBottom: SPACING.lg },
  modalMessage: { fontSize: FONT_SIZE.md, color: COLORS.textSecondary, lineHeight: 22, marginBottom: SPACING.sm },
  ...
  modalCancelText: { fontSize: FONT_SIZE.md, color: COLORS.textSecondary, fontWeight: FONT_WEIGHT.medium },
  modalSaveBtnWrap: { flex: 1, borderRadius: RADIUS.md, overflow: 'hidden' },
  modalSaveBtn: { paddingVertical: SPACING.md, alignItems: 'center' },
  modalSaveText: { fontSize: FONT_SIZE.md, color: '#fff', fontWeight: FONT_WEIGHT.semibold },
  fullCloseBtn: { marginTop: SPACING.lg, paddingVertical: SPACING.md, borderRadius: RADIUS.md, backgroundColor: COLORS.primary, alignItems: 'center' },
  fullCloseBtnText: { fontSize: FONT_SIZE.md, color: '#fff', fontWeight: FONT_WEIGHT.semibold },

  // ESP32
  inputLabel: { fontSize: FONT_SIZE.sm, color: COLORS.textSecondary, fontWeight: FONT_WEIGHT.medium, marginBottom: SPACING.sm, alignSelf: 'flex-start' },
  ipWrap: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, backgroundColor: COLORS.backgroundLight, borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: SPACING.md, height: 50, width: '100%', marginBottom: SPACING.xs },
  ipWrapErr: { borderColor: COLORS.danger },
  ipInput: { flex: 1, fontSize: FONT_SIZE.md, color: COLORS.textPrimary, fontFamily: 'monospace' },
  inputError: { fontSize: FONT_SIZE.xs, color: COLORS.danger, alignSelf: 'flex-start', marginBottom: SPACING.sm },
  mockBanner: { flexDirection: 'row', alignItems: 'flex-start', gap: SPACING.sm, backgroundColor: 'rgba(245,158,11,0.08)', borderRadius: RADIUS.md, padding: SPACING.md, marginBottom: SPACING.lg, borderLeftWidth: 3, borderLeftColor: COLORS.warning },
  mockBannerText: { fontSize: FONT_SIZE.xs, color: COLORS.warning, flex: 1, lineHeight: 18 },

  // Notifications toggles
  toggleList: { width: '100%', borderRadius: RADIUS.md, overflow: 'hidden', borderWidth: 1, borderColor: COLORS.border, marginBottom: SPACING.sm },
  toggleRow: { flexDirection: 'row', alignItems: 'center', padding: SPACING.md, backgroundColor: COLORS.backgroundLight },
  ...
  // Tenant Management
  mgmtList: { width: '100%', borderRadius: RADIUS.md, overflow: 'hidden', borderWidth: 1, borderColor: COLORS.border, marginBottom: SPACING.sm },
  mgmtItem: { flexDirection: 'row', alignItems: 'center', padding: SPACING.md, backgroundColor: COLORS.backgroundLight },
  mgmtIcon: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  mgmtContent: { flex: 1, marginLeft: SPACING.md },
  mgmtLabel: { fontSize: FONT_SIZE.md, color: COLORS.textPrimary, fontWeight: FONT_WEIGHT.medium },
  mgmtDesc: { fontSize: FONT_SIZE.xs, color: COLORS.textMuted, marginTop: 2 },

  // About
  aboutDetails: { width: '100%', gap: 0, borderRadius: RADIUS.md, overflow: 'hidden', borderWidth: 1, borderColor: COLORS.border, marginBottom: SPACING.sm },
  aboutRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: SPACING.sm, paddingHorizontal: SPACING.md, backgroundColor: COLORS.backgroundLight, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  aboutLabel: { fontSize: FONT_SIZE.sm, color: COLORS.textMuted },
  aboutValue: { fontSize: FONT_SIZE.sm, color: COLORS.textPrimary, fontWeight: FONT_WEIGHT.medium },
